...
## DEC-014 - 独立 Landing Page 与未签名 macOS 预览发布
...
- 发布边界：当前用户已授权在全部门禁通过后推送实现、创建 `decision/014-landing-page-and-preview-release`、发布不可变 `v0.0.2` GitHub prerelease，并部署 GitHub Pages；任何后续版本仍需要新的当前授权。
- 标签：`decision/014-landing-page-and-preview-release`。
