...
PiNodeErrorCode _mapProtocolFailureCode(String value) => switch (value) {
  ...
  'data_loss' => PiNodeErrorCode.dataLoss,
  'resource_exhausted' => PiNodeErrorCode.resourceExhausted,
  'protocol_violation' => PiNodeErrorCode.protocolViolation,
  'unavailable' => PiNodeErrorCode.unavailable,
  'internal' => PiNodeErrorCode.internal,
