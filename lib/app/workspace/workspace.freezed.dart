...
@JsonKey(includeToJson: false) PiNodeConnectionSnapshot get connection; PiNodeCompositionAvailability get nodeAvailability; WorkspaceEventStatus get eventStatus; WorkspacePromptAdmissionStatus get promptAdmissionStatus;@JsonKey(includeToJson: false) PiProjectBootstrap? get projectBootstrap;@JsonKey(includeToJson: false) List<PiKnownProject> get knownProjects;@JsonKey(includeToJson: false) PiProject? get selectedProject;@JsonKey(includeToJson: false) PiDirectoryListing? get projectDirectory;@JsonKey(includeToJson: false) List<PiSessionSummary> get sessions;@JsonKey(includeToJson: false) PiSessionId? get selectedSessionId;@JsonKey(includeToJson: false) PiSessionId? get sessionAdminSessionId;@JsonKey(includeToJson: false) PiSessionAdminOperation? get sessionAdminOperation;@JsonKey(includeToJson: false) List<PiMessage> get messages;@JsonKey(includeToJson: false) PiSessionTree? get sessionTree;@JsonKey(includeToJson: false) PiSessionTreeMutationOperation? get sessionTreeMutationOperation; bool get sessionTreeLoading; bool get sessionTreeMutationLoading; int get composerDraftGeneration;@JsonKey(includeToJson: false) String? get composerDraft; bool get projectLoading; bool get projectBrowsing; bool get projectValidating; bool get projectTrustApproving; bool get sessionsLoading; bool get conversationLoading; bool get creatingSession; bool get sessionAdminLoading; bool get sending; bool get stopping; String? get nodeError; String? get projectError; String? get sessionError; String? get sessionAdminError; String? get sessionTreeError; String? get conversationError; String? get promptError; String? get statusMessage;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,connection,nodeAvailability,eventStatus,promptAdmissionStatus,projectBootstrap,const DeepCollectionEquality().hash(knownProjects),selectedProject,projectDirectory,const DeepCollectionEquality().hash(sessions),selectedSessionId,sessionAdminSessionId,sessionAdminOperation,const DeepCollectionEquality().hash(messages),sessionTree,sessionTreeMutationOperation,sessionTreeLoading,sessionTreeMutationLoading,composerDraftGeneration,composerDraft,projectLoading,projectBrowsing,projectValidating,projectTrustApproving,sessionsLoading,conversationLoading,creatingSession,sessionAdminLoading,sending,stopping,nodeError,projectError,sessionError,sessionAdminError,sessionTreeError,conversationError,promptError,statusMessage]);

@override
String toString() {
  return 'WorkspaceModel(connection: $connection, nodeAvailability: $nodeAvailability, eventStatus: $eventStatus, promptAdmissionStatus: $promptAdmissionStatus, projectBootstrap: $projectBootstrap, knownProjects: $knownProjects, selectedProject: $selectedProject, projectDirectory: $projectDirectory, sessions: $sessions, selectedSessionId: $selectedSessionId, sessionAdminSessionId: $sessionAdminSessionId, sessionAdminOperation: $sessionAdminOperation, messages: $messages, sessionTree: $sessionTree, sessionTreeMutationOperation: $sessionTreeMutationOperation, sessionTreeLoading: $sessionTreeLoading, sessionTreeMutationLoading: $sessionTreeMutationLoading, composerDraftGeneration: $composerDraftGeneration, composerDraft: $composerDraft, projectLoading: $projectLoading, projectBrowsing: $projectBrowsing, projectValidating: $projectValidating, projectTrustApproving: $projectTrustApproving, sessionsLoading: $sessionsLoading, conversationLoading: $conversationLoading, creatingSession: $creatingSession, sessionAdminLoading: $sessionAdminLoading, sending: $sending, stopping: $stopping, nodeError: $nodeError, projectError: $projectError, sessionError: $sessionError, sessionAdminError: $sessionAdminError, sessionTreeError: $sessionTreeError, conversationError: $conversationError, promptError: $promptError, statusMessage: $statusMessage)';
}
...
@useResult
$Res call({
@JsonKey(includeToJson: false) PiNodeConnectionSnapshot connection, PiNodeCompositionAvailability nodeAvailability, WorkspaceEventStatus eventStatus, WorkspacePromptAdmissionStatus promptAdmissionStatus,@JsonKey(includeToJson: false) PiProjectBootstrap? projectBootstrap,@JsonKey(includeToJson: false) List<PiKnownProject> knownProjects,@JsonKey(includeToJson: false) PiProject? selectedProject,@JsonKey(includeToJson: false) PiDirectoryListing? projectDirectory,@JsonKey(includeToJson: false) List<PiSessionSummary> sessions,@JsonKey(includeToJson: false) PiSessionId? selectedSessionId,@JsonKey(includeToJson: false) PiSessionId? sessionAdminSessionId,@JsonKey(includeToJson: false) PiSessionAdminOperation? sessionAdminOperation,@JsonKey(includeToJson: false) List<PiMessage> messages,@JsonKey(includeToJson: false) PiSessionTree? sessionTree,@JsonKey(includeToJson: false) PiSessionTreeMutationOperation? sessionTreeMutationOperation, bool sessionTreeLoading, bool sessionTreeMutationLoading, int composerDraftGeneration,@JsonKey(includeToJson: false) String? composerDraft, bool projectLoading, bool projectBrowsing, bool projectValidating, bool projectTrustApproving, bool sessionsLoading, bool conversationLoading, bool creatingSession, bool sessionAdminLoading, bool sending, bool stopping, String? nodeError, String? projectError, String? sessionError, String? sessionAdminError, String? sessionTreeError, String? conversationError, String? promptError, String? statusMessage
});
...
as List<PiMessage>,sessionTree: freezed == sessionTree ? _self.sessionTree : sessionTree // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _WorkspaceModel() when $default != null:
return $default(_that.connection,_that.nodeAvailability,_that.eventStatus,_that.promptAdmissionStatus,_that.projectBootstrap,_that.knownProjects,_that.selectedProject,_that.projectDirectory,_that.sessions,_that.selectedSessionId,_that.sessionAdminSessionId,_that.sessionAdminOperation,_that.messages,_that.sessionTree,_that.sessionTreeMutationOperation,_that.sessionTreeLoading,_that.sessionTreeMutationLoading,_that.composerDraftGeneration,_that.composerDraft,_that.projectLoading,_that.projectBrowsing,_that.projectValidating,_that.projectTrustApproving,_that.sessionsLoading,_that.conversationLoading,_that.creatingSession,_that.sessionAdminLoading,_that.sending,_that.stopping,_that.nodeError,_that.projectError,_that.sessionError,_that.sessionAdminError,_that.sessionTreeError,_that.conversationError,_that.promptError,_that.statusMessage);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,connection,nodeAvailability,eventStatus,promptAdmissionStatus,projectBootstrap,const DeepCollectionEquality().hash(_knownProjects),selectedProject,projectDirectory,const DeepCollectionEquality().hash(_sessions),selectedSessionId,sessionAdminSessionId,sessionAdminOperation,const DeepCollectionEquality().hash(_messages),sessionTree,sessionTreeMutationOperation,sessionTreeLoading,sessionTreeMutationLoading,composerDraftGeneration,composerDraft,projectLoading,projectBrowsing,projectValidating,projectTrustApproving,sessionsLoading,conversationLoading,creatingSession,sessionAdminLoading,sending,stopping,nodeError,projectError,sessionError,sessionAdminError,sessionTreeError,conversationError,promptError,statusMessage]);
