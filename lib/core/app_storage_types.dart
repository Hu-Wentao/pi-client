...
enum AppStorageSemantics {
  nativePlatformProtected,
  nativePublicKeyPreferencesOnly,
  webNoSecretNoPersistence,
}

@immutable
final class AppStorageBoundary {
  const AppStorageBoundary._({
    required this.semantics,
    required this.persistsAcrossRestarts,
    required this.allowsSecretPersistence,
  });

  static const nativePlatformProtected = AppStorageBoundary._(
    semantics: AppStorageSemantics.nativePlatformProtected,
    persistsAcrossRestarts: true,
    allowsSecretPersistence: true,
  );

  static const nativePublicKeyPreferencesOnly = AppStorageBoundary._(
    semantics: AppStorageSemantics.nativePublicKeyPreferencesOnly,
    persistsAcrossRestarts: true,
    allowsSecretPersistence: false,
  );

  static const webNoSecretNoPersistence = AppStorageBoundary._(
    semantics: AppStorageSemantics.webNoSecretNoPersistence,
    persistsAcrossRestarts: false,
    allowsSecretPersistence: false,
  );

  final AppStorageSemantics semantics;
  final bool persistsAcrossRestarts;
  final bool allowsSecretPersistence;
}
