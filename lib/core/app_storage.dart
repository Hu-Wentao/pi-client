...
class AppStorageConfiguration {
  ...
  static AppStorageConfiguration forChannel(
    ...
    AppDistributionChannel.unsignedPreview => const AppStorageConfiguration(
      ...
      // This key is intentionally public and provides no secrecy. Its purpose
      // is to let the unsigned preview open an isolated preferences store
      // without requiring a Keychain entitlement.
    ...
    AppDistributionChannel.standard => AppStorageConfiguration(
      ...
      usesPlatformSecureStorage: !debugMode,
      encryptionKeyBytes: debugMode ? _debugEncryptionKey : null,
    ),
  };
