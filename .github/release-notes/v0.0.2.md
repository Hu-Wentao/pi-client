...
This note is immutable historical evidence for the exact `v0.0.2` release. Its pi-web requirements and compatibility statements describe only that early preview; they have no authority over the current Pi Client `1.0` product scope or architecture.
